...
import FormContainer, {
  SubmitSection,
} from '@qoruz/pages/events/drive-roi-through-content/form/form.style';
        ...
        <>
          ...
          <form onSubmit={handleSubmit(handleRegistration)}>
            ...
            <SubmitSection>
              ...
              <p className='registered-section'>
                <span className='hundread-plus'>100+</span>
                <span className='text'>people registered</span>
              </p>
            </SubmitSection>
          </form>
          <p className='terms-register'>
            By clicking Register, I have read and agree to Qoruz’s Terms and
            Privacy Policy
          </p>
        </>
      )}
