...
const WhatYouNeedMobile = () => {
  ...
  return (
    <>
      <WhatYouNeedStyled className='what-you-need-intro mobile' id='pricing'>
        <Container className='screen-contain container'>
          <Row>
            ...
            <Col lg={8} className='what-you-need-intro-right'>
              ...
              {selected == 1 && (
                <Credits className='credits'>
                  ...
                  <div className='influencer-number-slide'>
                    <div
                      style={{
                        display: 'flex',
...
export default WhatYouNeedMobile;
